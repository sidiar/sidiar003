...
EOD;
    ...
    public function testPublishArticle() {
        ...
        $article->id = self::$article_id;
        $article->publish_date_from = '2014-07-20';
        $article->publish_date_to = '2014-09-20';
        $article->status = 0;
        ...
        $article->id = self::$article_id;
        $article->publish_date_from = '2013-07-20';
        $article->publish_date_to = '2014-09-20';
        /* aqui chequear que la fecha no sea antigua y poner en 1 el status*/
        $article->status = 1;
